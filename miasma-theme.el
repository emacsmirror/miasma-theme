...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-added ((,class (:foreground ,miasma-marble :background ,miasma-eucalyptus :extend t))))
   `(magit-diff-removed ((,class (:foreground ,miasma-marble :background ,miasma-fire :extend t))))
